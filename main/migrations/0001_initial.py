    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ru', models.CharField(max_length=50, null=True, verbose_name='Название дисциплины')),
                ('name_en', models.CharField(max_length=50, null=True, verbose_name='Название дисциплины')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ru', models.TextField(max_length=100, null=True, unique=True, verbose_name='Название группы')),
                ('name_en', models.TextField(max_length=100, null=True, unique=True, verbose_name='Название группы')),
                ('description', models.TextField(max_length=100, verbose_name='Описание')),
                ('description_ru', models.TextField(max_length=100, null=True, verbose_name='Описание')),
                ('description_en', models.TextField(max_length=100, null=True, verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ru', models.CharField(max_length=50, null=True, verbose_name='Название должности')),
                ('name_en', models.CharField(max_length=50, null=True, verbose_name='Название должности')),
                ('salary', models.FloatField(max_length=50, verbose_name='Оклад')),
                ('salary_ru', models.FloatField(max_length=50, null=True, verbose_name='Оклад')),
                ('salary_en', models.FloatField(max_length=50, null=True, verbose_name='Оклад')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, verbose_name='Имя')),
                ('name_ru', models.CharField(max_length=50, null=True, verbose_name='Имя')),
                ('name_en', models.CharField(max_length=50, null=True, verbose_name='Имя')),
                ('surname', models.CharField(max_length=50, verbose_name='Фамилия')),
                ('surname_ru', models.CharField(max_length=50, null=True, verbose_name='Фамилия')),
                ('surname_en', models.CharField(max_length=50, null=True, verbose_name='Фамилия')),
                ('middle_name', models.CharField(blank=True, default='Отсутсвут', max_length=50, null=True, verbose_name='Отчество')),
                ('middle_name_ru', models.CharField(blank=True, default='Отсутсвут', max_length=50, null=True, verbose_name='Отчество')),
                ('middle_name_en', models.CharField(blank=True, default='Отсутсвут', max_length=50, null=True, verbose_name='Отчество')),
                ('date_of_birth', models.DateField(default=0, verbose_name='Дата рождения')),
